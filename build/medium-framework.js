    ...
    fn: {
      ...
      is: function (selector) {
        ...
        return $list.reduce(function (is, $el) {
          return is || (_.isString(selector) ? _.isIE ? $el.msMatchesSelector(selector) : $el.matches(selector) : _.isNodeList(selector) ? selector.is($el) : selector === $el);
        }, false);
      },
      clone: function () {
        if (_.isNodeList(this)) {
